        ...
        return (
            <View style={styles.notAllowed}>
                <TouchableOpacity style={styles.btn} onPress={allowPermission}>
                    <Text style={styles.btnText}>Autorisation de la camera</Text>
                </TouchableOpacity>
            </View>
        )
    }
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            ref={camRef} >
                ...
                <AppIcon style={styles.sideIcons} IonName="flash-outline" color="#eee" size={20} onPress={changeFlashMode} />
                <AppIcon style={styles.sideIcons} IonName="ios-musical-notes-outline" color="#eee" size={20} />
                </View>
